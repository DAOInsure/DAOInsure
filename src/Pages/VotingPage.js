  ...
  useEffect(() => {
    async function init() {
      ...
      let closer = await textileClient.listen(
        ...
        [{ actionTypes: ["CREATE"], collectionName: "messageData" }],
        (reply, error) => {}
      );
      ...
      <VStack alignItems="flex-start" width="100%">
        ...
        <HStack>
          <Image
            ...
            borderRadius="10px"
            height="70px"
            src="https://psmag.com/.image/ar_16:9%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cg_faces:center%2Cq_auto:good%2Cw_768/MTY0NTc1NjUzNDA2OTc1NzUz/gettyimages-1152467877.jpg"
          />
          <Image
            onClick={handleImage}
            borderRadius="10px"
            height="70px"
            src="https://images.firstpost.com/wp-content/uploads/large_file_plugin/2020/02/1582263146_1.jpg"
          />
          <Image
            onClick={handleImage}
            borderRadius="10px"
            height="70px"
            src="https://www.insurancechat.co.za/wp-content/uploads/2021/01/Reen-Tweeling-area-770x445.jpeg"
          />
        </HStack>
        <Text>Summary of the incident.</Text>
                    ...
                    >
                      ...
                      >
                        <Avatar
                          size="sm"
                          icon={
                            <Jazzicon diameter="32" address={message.address} />
                          }
                        />
                      </Box>
                    </Tooltip>
