...
function MakeClaim() {
  ...
  const { createProposal, signerAddress, claimableAmount, getClaimableAmount } =
    web3Context;
          ...
          <VStack width="100%" spacing={5} alignItems="flex-start">
            ...
            <VStack spacing={5} width="100%">
              <FormControl isRequired>
                ...
                <Skeleton isLoaded={!isPageLoading}>
                  <Input
                    onChange={(e) => handleInputChange(e, setClaimTitle)}
                  />
                </Skeleton>
              </FormControl>
              <FormControl isRequired>
                ...
                <Skeleton isLoaded={!isPageLoading}>
                  <Textarea
                    onChange={(e) => handleInputChange(e, setClaimSummary)}
                    row="10"
                  />
                </Skeleton>
                <Skeleton isLoaded={!isPageLoading}>
                ...
                <HStack width="100%">
                  <FormControl isRequired>
                    ...
                    <Skeleton isLoaded={!isPageLoading}>
                      <Input
                        onChange={(e) =>
                          handleInputChange(e, setDateOfIncident)
                        }
                        type="date"
                      />
                    </Skeleton>
